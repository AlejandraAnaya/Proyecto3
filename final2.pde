//Intento de aplicar la herencia en la clase del Personaje :( 
...
PImage titulo, imagen, inicio, batalla, ganador, seleccion, personajes, letrero; 
...
/*
  ...
  ojo = new Ojo(500, 200);
  boca = new Boca (600, 300);
  oreja = new Oreja (600, 200);
  mano = new Mano (400, 200);
  nariz = new Nariz(400, 200);
  cerebro = new Cerebro (700, 300); 
